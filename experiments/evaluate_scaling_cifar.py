...
parser.add_argument(
    "--num_points", type=int, nargs="+", default=[1000, 2500, 5000, 10000, 25000, 49000]
)
...
for num in num_points:
    ...
    metrics = generate_metrics(
        estimates[:num], ground_truth_estimates[:num], ground_truth_internal
    )
    ...
    metrics = generate_metrics(
        estimates, ground_truth_estimates[:num], ground_truth_internal
    )
