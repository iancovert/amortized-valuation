...
parser.add_argument(
    "--num_contributions", type=int, nargs="+", default=[10, 25, 50, 100, 150, 200, 250]
)
...
filenames = [
    os.path.join("data_files", dataset, f"mc-{num_points}-{250}-{seed}.npy")
...
for count in num_contributions:
    ...
    filenames = [
        os.path.join("data_files", dataset, f"mc-{num_points}-{num_points}-{seed}.npy")
