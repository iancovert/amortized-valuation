...
parser.add_argument('--num_points', type=int, nargs='+', default=[250, 500, 1000, 2500, 5000, 10000])
...
for num in num_points:
    ...
    filenames = [os.path.join('data_files', dataset, f'mc-{num}-{250}-{seed}.npy')
    ...
    filenames = [os.path.join('data_files', dataset, f'mc-{num}-{num}-{seed}.npy')
